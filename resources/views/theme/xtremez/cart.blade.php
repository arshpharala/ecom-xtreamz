...
@section('content')
  ...
  <section class="cart-section pb-5">
    <div class="container">
      ...
      <div id="empty-cart-container" class="{{ $variants->isEmpty() ? '' : 'd-none' }}">
        <div class="cart-list bg-white p-5 rounded-3 shadow-sm text-center">
          <div class="mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 83 88" fill="none">
          ...
          <p class="fs-4 text-black-50 mb-4">Your cart is empty.</p>
          <a href="{{ route('products') }}" class="btn btn-secondary px-5">CONTINUE SHOPPING</a>
        </div>
      </div>

      {{-- Cart Content Container --}}
      <div id="cart-content" class="{{ $variants->isEmpty() ? 'd-none' : '' }}">
        <div class="row">
          <div class="col-md-12 col-lg-7 col-xl-8">
            <div class="cart-selectall d-flex align-items-center justify-content-between mb-3 d-none d-md-flex">
              ...
              <div class="clear-cart" style="display: none">
                <a href="javascript:void(0)" class="text-dark">Clear Items</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="cart-summary bg-grey p-4">
              <ul class="list-unstyled mb-4">
                <li class="d-flex justify-content-between mb-2">
                  <span>Subtotal</span>
                  <span class="cart-sub-total">{!! price_format(active_currency(), $cart['subTotal']) !!}</span>
                </li>
                <li class="d-flex justify-content-between mb-2">
                  <span>Taxes</span>
                  <span class="cart-taxes">{!! price_format(active_currency(), $cart['tax']) !!}</span>
                </li>
